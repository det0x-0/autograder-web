...
test("autograderGradingResultToJSFile() base", async function() {
    ...
    const key = "{\"arguments\":{\"assignment-id\":\"hw0\",\"course-id\":\"course101\",\"source\":\"testing\",\"source-version\":\"0.0.0\",\"target-email\":\"course-student@test.edulinq.org\",\"target-submission\":\"1697406265\",\"user-email\":\"course-admin@test.edulinq.org\",\"user-pass\":\"c22755f48fa0ef601e8d57a3ba169eeda80e9b2d4eaecc2c2ca2ffc887722f7c\"},\"endpoint\":\"api/v03/courses/assignments/submissions/fetch/user/attempt\",\"files\":[]}";

    let data = Testdata.testAPIResponses[key];
    expect(data).toBeDefined();

    let gradingResult = data['content']['grading-result'];
